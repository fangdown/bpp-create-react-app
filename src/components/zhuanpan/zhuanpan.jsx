...
class Home extends React.Component {
  ...
  rotatePanel = (distance) => {
    ...
    console.log('2222222', this.rotatePanel(distance))
    console.log('3333', typeof this.rotatePanel(distance))
    // requestAnimationFrame(this.rotatePanel(distance));
    // setInterval(() => this.rotatePanel.bind(this, distance), 0);
  }
